    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <button type="button"
                    class="bg-blue-600 hover:bg-blue-700 text-white rounded-full p-2 shadow-lg flex items-center justify-center"
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-7">
                ...
                <div class="flex flex-col items-center -mt-12 mb-6">
                    <div class="relative group">
                        <img id="profileImagePreview"
                            ...
                            class="size-40 rounded-xl border-4 border-blue-400 shadow-xl object-cover cursor-pointer transition-transform duration-300 hover:ring-4 hover:ring-blue-300"
                ...
                <h2 class="text-3xl font-extrabold text-blue-700 mb-8 text-center tracking-tight drop-shadow">Profil
                    bearbeiten
                </h2>
                ...
                <div>
                    ...
                    <div
                        class="flex items-center rounded-xl border border-blue-300 bg-blue-50/50 shadow focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500 transition-all duration-150">
                        <span class="pl-4 py-2 text-gray-500 select-none rounded-l-xl border-r border-blue-200">
                ...
                <div>
                    <label for="current_password" class="block text-sm font-semibold text-blue-700 mb-1">Aktuelles
                        Passwort</label>
